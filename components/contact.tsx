            ...
            <dl className='mt-10 space-y-4 text-base leading-7 text-gray-300'>
              ...
              <div className='flex gap-x-4'>
                ...
                <dd>
                  ...
                  >
                    elitesportsville&rsquo;s@gmail.com
                  </a>
                </dd>
              </div>
            </dl>
        ...
        >
          <div className='mx-auto max-w-xl lg:mr-0 lg:max-w-lg'>
            ...
            <div className='mt-8 flex justify-end'>
              <button
                type='submit'
                className='rounded-md bg-bright-purple-dark px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-bright-purple-dark'
              >
                Send message
              </button>
            </div>
